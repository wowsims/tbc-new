...
func RegisterAllOnUseCds() {
	...
	shared.NewSimpleStatActive(31617) // Ancient Draenei War Talisman
	shared.NewSimpleStatActive(32654) // Crystalforged Trinket
	shared.NewSimpleStatActive(33831) // Berserker's Call
	shared.NewSimpleStatActive(35702) // Figurine - Shadowsong Panther
	shared.NewSimpleStatActive(38287) // Empty Mug of Direbrew
	...
	shared.NewSimpleStatActive(34050) // Battlemaster's Perseverance
	shared.NewSimpleStatActive(34162) // Battlemaster's Depravity
	shared.NewSimpleStatActive(34163) // Battlemaster's Cruelty
	shared.NewSimpleStatActive(35326) // Battlemaster's Alacrity
	shared.NewSimpleStatActive(35327) // Battlemaster's Alacrity
