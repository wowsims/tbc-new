...
// badly. Flat Record<number, number> keyed by anyId(), so an OtherAction id and a spellId of the
// same numeric value are indistinguishable; safe only because OtherAction values are small and
// spell ids are large.
