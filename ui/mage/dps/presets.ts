...
export const P3_EP_PRESET = PresetUtils.makePresetEpWeights(
	...
	Stats.fromMap(
		{
			[Stat.StatMana]: 0.03,
			[Stat.StatIntellect]: 1.66,
			[Stat.StatSpirit]: 1.19,
			[Stat.StatSpellDamage]: 1,
			[Stat.StatArcaneDamage]: 0.95,
			[Stat.StatFrostDamage]: 0.04,
			[Stat.StatSpellHitRating]: 1.5,
			[Stat.StatSpellCritRating]: 0.79,
			[Stat.StatSpellHasteRating]: 0.62,
			[Stat.StatSpellPenetration]: 0,
			[Stat.StatMP5]: 0.67,
		},
		{
			[PseudoStat.PseudoStatSchoolHitPercentArcane]: 1.6,
			[PseudoStat.PseudoStatSchoolHitPercentFrost]: 0.09,
		},
	),
);
